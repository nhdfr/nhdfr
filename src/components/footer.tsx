        ...
        <footer>
            <div className="container mx-auto px-4 py-8 max-w-4xl flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-0">
                ...
                <div className="flex gap-2 order-1 sm:order-2">
                    <Link href="https://github.com/d3xfoo" className="rounded-md border border-border p-2 hover:bg-accent/40 transition-colors" aria-label="GitHub" target="_blank" rel="noopener noreferrer">
                    ...
                    <Link href="https://x.com/d3xfoo" className="rounded-md border border-border p-2 hover:bg-accent/40 transition-colors" aria-label="Twitter" target="_blank" rel="noopener noreferrer">
