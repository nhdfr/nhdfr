...
const Footer = () => {
    return (
        <footer>
            <div className="container mx-auto px-4 py-10 max-w-4xl flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-0 border-t border-border">
                <span className="text-sm text-muted-foreground order-2 sm:order-1 text-center sm:text-left">
                    © 2025 All rights reserved. 
                </span>
                <div className="flex gap-2 order-1 sm:order-2">
                    <Link href="https://github.com/d3xfoo" className="rounded-md border border-border p-2 hover:bg-black/5 dark:hover:bg-white/10 transition-colors" aria-label="GitHub" target="_blank" rel="noopener noreferrer">
                    ...
                    <Link href="https://x.com/d3xfoo" className="rounded-md border border-border p-2 hover:bg-black/5 dark:hover:bg-white/10 transition-colors" aria-label="Twitter" target="_blank" rel="noopener noreferrer">
                    ...
                    <Link href="mailto:conversenahid@gmail.com" className="rounded-md border border-border p-2 hover:bg-black/5 dark:hover:bg-white/10 transition-colors" aria-label="Email">
                    ...
                    <Link href="/rss.xml" className="rounded-md border border-border p-2 hover:bg-black/5 dark:hover:bg-white/10 transition-colors" aria-label="RSS">
